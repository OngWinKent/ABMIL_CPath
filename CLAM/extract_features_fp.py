...
parser.add_argument('--model_name', type=str, default='resnet50_trunc', choices=['resnet50_trunc', 'uni_v1', 'conch_v1', 'r18','sd_vae'])
...
if __name__ == '__main__':
	...
	for bag_candidate_idx in tqdm(range(total)):
		...
		if args.distributed:
			loader = DataLoader(dataset=dataset, batch_size=args.batch_size, sampler=DistributedSampler(dataset),**loader_kwargs)
		else:
